 ...
 */
public class ServerGetFriends extends AsyncTask<String, String, JSONArray> {
    private Context context;
    private Constants constants;
    String name, friend;
    JSONArray result;
    HttpRequest conn;
    public ServerGetFriends(Context context)
    {
    ...
    public JSONArray getFriends(String _user){
        constants = new Constants();
        ...
        client.get(constants.BASE_URL + "getFriends2.php",params, new JsonHttpResponseHandler() {
            @Override
