 ...
 */
public class ServerSendRequest extends AsyncTask<String, String, Integer> {
    ...
    int result;
    HttpRequest conn;
    public ServerSendRequest(Context context)
    {
    ...
    public int searchName(String _user, String _friend){
        ...
        client.get(constants.BASE_URL + "sendRequest.php",params, new JsonHttpResponseHandler() {
            @Override
