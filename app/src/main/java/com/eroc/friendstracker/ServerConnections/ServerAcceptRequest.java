 ...
 */
public class ServerAcceptRequest extends AsyncTask<String, String, Integer> {
    ...
    int result;
    HttpRequest conn;
    public ServerAcceptRequest(Context context)
    {
    ...
    public int acceptRequest(String _user, String _friend){
        constants = new Constants();
        ...
        client.get(constants.BASE_URL + "acceptRequest.php",params, new JsonHttpResponseHandler() {
            @Override
